...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	DB::table('products')->insert([
    		...
    		'thumbnail' => 'https://i.ebayimg.com/00/s/ODY0WDgwMA==/z/9S4AAOSwMZRanqb7/$_35.JPG?set_id=89040003C1',
    		'price' => 698.88
    	]);
    	...
    	DB::table('products')->insert([
    		...
    		'thumbnail' => 'https://i.ebayimg.com/00/s/MTYwMFg5OTU=/z/9UAAAOSwFyhaFXZJ/$_35.JPG?set_id=89040003C1',
    		'price' => 983.00
    	]);
    	...
    	DB::table('products')->insert([
    		...
    		'thumbnail' => 'https://i.ebayimg.com/00/s/MTYwMFg4MzA=/z/G2YAAOSwUJlZ4yQd/$_35.JPG?set_id=89040003C1',
    		'price' => 675.00
    	]);
    	...
    	DB::table('products')->insert([
    		...
    		'thumbnail' => 'https://i.ebayimg.com/00/s/NjQxWDQyNA==/z/VDoAAOSwgk1XF2oo/$_35.JPG?set_id=89040003C1',
    		'price' => 159.99
    	]);
    	...
    	DB::table('products')->insert([
    		...
    		'thumbnail' => 'https://ssli.ebayimg.com/images/g/aJ0AAOSw7zlaldY2/s-l640.jpg',
    		'price' => 68.00
    	]);
    	...
    	DB::table('products')->insert([
    		...
    		'thumbnail' => 'https://i.ebayimg.com/images/g/u-kAAOSw9p9aXNyf/s-l500.jpg',
    		'price' => 129.99
    	]);
    }
}
